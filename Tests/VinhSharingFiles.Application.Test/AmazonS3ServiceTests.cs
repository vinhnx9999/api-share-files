...
namespace VinhSharingFiles.Application.Test
{
    public class AmazonS3ServiceTests
    {
        ...
        {
            //Arrange
            var expectedItems = new List<FileDto>
            {
                new() { Id = 1, FileName = "FileName 1", ContentType="text/plain", Description = "Description 1" },
                new() { Id = 2, FileName = "FileName 2", ContentType="text/plain", Description = "Description 2" }
            };
            int userId = 1;
